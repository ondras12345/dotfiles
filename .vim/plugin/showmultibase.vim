" https://www.vim.org/scripts/script.php?script_id=3070
" ========================================================================== "
" Name:        showmultibase                                                 "
" Version:     1.1                                                           "
" Updated:     2020-03-10 16:07:17                                           "
...
"              Ian Munsie <darkstarsword AT gmail DOT com>                   "
"                Bugfix: Oct/Hex/Dec FillSegment, SegmentSize            "
"                configuration fix for Register and Display                  "
" ========================================================================== "
...
" NOTE: "qy yanks the current selection to register 'q'. If there was no
" visual selection, the command y will be terminated with <ESC>, otherwise the
" <ESC> has no effect.
" TODO: If the 'q' register is used by other plugins or the user, it will
" probably interfere with the current way of deciding if the selection or the
" number under the cursor position is used. This is something to improve.
" If you happen to read this and know how to pass the current selection and
" passing nothing if there was no selection, please let me know!
if !exists('g:ShowMultiBase_General_UseDefaultMappings')
 \ || g:ShowMultiBase_General_UseDefaultMappings == 1
  noremap <silent> \=  "qy<ESC>:call ShowMultiBase(  )<CR>
  noremap <silent> \b= "qy<ESC>:call ShowMultiBase( 2)<CR>
  noremap <silent> \o= "qy<ESC>:call ShowMultiBase( 8)<CR>
  noremap <silent> \d= "qy<ESC>:call ShowMultiBase(10)<CR>
  noremap <silent> \h= "qy<ESC>:call ShowMultiBase(16)<CR>
endif
...
if exists('g:ShowMultiBase_Register_Octal_FillSegment')
  let s:r_fillSegOct = g:ShowMultiBase_Register_Octal_FillSegment
endif
if exists('g:ShowMultiBase_Register_Decimal_FillSegment')
  let s:r_fillSegDec = g:ShowMultiBase_Register_Decimal_FillSegment
endif
if exists('g:ShowMultiBase_Register_Hexadecimal_FillSegment')
  let s:r_fillSegHex = g:ShowMultiBase_Register_Hexadecimal_FillSegment
endif
...
if exists('g:ShowMultiBase_Register_Octal_SegmentSize')
  let s:r_segSizeOct = g:ShowMultiBase_Register_Octal_SegmentSize
endif
if exists('g:ShowMultiBase_Register_Decimal_SegmentSize')
  let s:r_segSizeDec = g:ShowMultiBase_Register_Decimal_SegmentSize
endif
if exists('g:ShowMultiBase_Register_Hexadecimal_SegmentSize')
  let s:r_segSizeHex = g:ShowMultiBase_Register_Hexadecimal_SegmentSize
endif
...
if exists('g:ShowMultiBase_Display_Octal_SegmentSize')
  let s:d_segSizeOct = g:ShowMultiBase_Display_Octal_SegmentSize
endif
if exists('g:ShowMultiBase_Display_Decimal_SegmentSize')
  let s:d_segSizeDec = g:ShowMultiBase_Display_Decimal_SegmentSize
endif
if exists('g:ShowMultiBase_Display_Hexadecimal_SegmentSize')
  let s:d_segSizeHex = g:ShowMultiBase_Display_Hexadecimal_SegmentSize
endif
...
if exists('g:ShowMultiBase_Display_Octal_FillSegment')
  let s:d_fillSegOct = g:ShowMultiBase_Display_Octal_FillSegment
endif
if exists('g:ShowMultiBase_Display_Decimal_FillSegment')
  let s:d_fillSegDec = g:ShowMultiBase_Decimal_FillSegment
endif
if exists('g:ShowMultiBase_Display_Hexadecimal_FillSegment')
  let s:d_fillSegHex = g:ShowMultiBase_Display_Hexadecimal_FillSegment
endif
...
function! ShowMultiBase(...) range
  let l:selection = getreg('q')
  call setreg('q', '')

  if l:selection != '' && a:firstline != a:lastline
    let l:selection = ''
  endif
  ...
  if (a:0 < 2)
    ...
    if l:n == ''
      ...
      for l:delimiter in l:delimiters
        let l:n1 = s:get_pattern_at_cursor(l:PrefixPattern . '\x\+\(' 
                 \ . l:delimiter . '\x\+\)*')
        if len(l:n1) > len(l:n)
          let l:n = l:n1
    ...
    if l:selection == ''
      let l:n = substitute(l:n, l:delimiter, '', 'g')
    else
      " TODO: The delimiter is not known for selection, so each given
      " delimiter shall be removed. This might have to be changed to be
      " consequent with the other mode.
      let l:delimiters = split(s:p_delimiters, '0', 1)
      for l:delimiter in l:delimiters
        let l:n = substitute(l:n, l:delimiter, '', 'g')
      endfor
        ...
        if match(l:n, l:PrefixPattern . '\x\+\(' . l:parse_delimiter . '\x\+\)*$') == 0
          ...
          if match(l:n, l:PrefixPattern . '[0-7]\+\(' . l:parse_delimiter . '[0-7]\+\)*$') == 0
            ...
            if l:selection == ''
              ...
              echoerr "Selected text " . l:selection 
                    \ . " not recognized as number! "
                    \ . " Try specifying the base!"
            endif
            return
          endif
        endif
