...
"nnoremap <buffer> r1 r+
nnoremap <buffer> r2 rě
nnoremap <buffer> r3 rš
nnoremap <buffer> r4 rč
nnoremap <buffer> r5 rř
nnoremap <buffer> r6 rž
nnoremap <buffer> r7 rý
nnoremap <buffer> r8 rá
nnoremap <buffer> r9 rí
...
nnoremap <buffer> r+ r1
nnoremap <buffer> rě r2
nnoremap <buffer> rš r3
nnoremap <buffer> rč r4
nnoremap <buffer> rř r5
nnoremap <buffer> rž r6
nnoremap <buffer> rý r7
nnoremap <buffer> rá r8
nnoremap <buffer> rí r9
nnoremap <buffer> ré r0
